...
func orchidWorkflowRoutes(rg *gin.RouterGroup) {
	...
	rg.GET("/approvals/approved", handlers.GetMyApprovedApprovals)
	rg.GET("/approvals/pending-read", handlers.GetMyPendingReads)
	rg.GET("/approvals/read", handlers.GetMyReadItems)
